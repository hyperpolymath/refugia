...
// Replace refugia, Refugia — See README.adoc for details., just run, Refugia started successfully. with actuals
= refugia — Quick Start for Users
:toc:
:toclevels: 2

== What is refugia?

Refugia — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./refugia-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/refugia/wiki
